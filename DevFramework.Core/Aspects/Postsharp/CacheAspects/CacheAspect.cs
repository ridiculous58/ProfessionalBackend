...
{
    [Serializable]
    public class CacheAspect:MethodInterceptionAspect//Methodun işleme alınmadan oce
    {
        ...
        {
            string methodName = string.Format("{0}.{1}.{2}", args.Method.ReflectedType.Namespace, args.Method.ReflectedType.Name, args.Method.Name);
            var arguments = args.Arguments.ToList();
            string key = string.Format("{0}({1})", methodName,
